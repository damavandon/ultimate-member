...
if ( ! class_exists( 'KIANFR_Welcome' ) ) {
  class KIANFR_Welcome{
    ...
    public function __construct() {
      ...
      if ( KIANFR::$premium && ( ! KIANFR::is_active_plugin( 'codestar-framework/codestar-framework.php' ) || apply_filters( 'kianfr_welcome_page', true ) === false ) ) { return; }
    ...
    public function add_about_menu() {
      add_management_page( 'Codestar Framework', 'Codestar Framework', 'manage_options', 'kianfr-welcome', array( $this, 'add_page_welcome' ) );
    }
