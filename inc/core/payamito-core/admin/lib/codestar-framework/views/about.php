...
<div class="kianfr-welcome-cols">
  ...
  <div class="kianfr--col kianfr--col-first">
    ...
    <p class="kianfr--text">Built in Object Oriented Programming paradigm with high number of custom fields and tons of options. It's highly modern and advanced framework.</p>
  </div>

  <div class="kianfr--col kianfr--col-first">
    <span class="kianfr--icon kianfr--<?php echo esc_attr( KIANFR::$premium ? 'active' : 'deactive' ); ?>"><i class="fas fa-<?php echo esc_attr( KIANFR::$premium ? 'check' : 'times' ); ?>"></i></span>
    <div class="kianfr--title">Customize Option Framework</div>
    <p class="kianfr--text">Inherits the default WordPress Customizer with integration of own custom fields. It's more powerful to customize your site on live.</p>
  </div>

  <div class="kianfr--col kianfr--col-first kianfr--last">
    <span class="kianfr--icon kianfr--<?php echo esc_attr( KIANFR::$premium ? 'active' : 'deactive' ); ?>"><i class="fas fa-<?php echo esc_attr( KIANFR::$premium ? 'check' : 'times' ); ?>"></i></span>
    <div class="kianfr--title">Metabox Option Framework</div>
    <p class="kianfr--text">Allows you to bring custom metabox settings to all of your pages and posts. We provide advanced settings with numerious number of fields.</p>
  </div>
  ...
  <div class="kianfr--col kianfr--col-first">
    ...
    <p class="kianfr--text">Allows you to bring custom nav menu item settings to all of your menus. We provide advanced settings with numerious number of fields.</p>
  </div>

  <div class="kianfr--col kianfr--col-first">
    <span class="kianfr--icon kianfr--<?php echo esc_attr( KIANFR::$premium ? 'active' : 'deactive' ); ?>"><i class="fas fa-<?php echo esc_attr( KIANFR::$premium ? 'check' : 'times' ); ?>"></i></span>
    <div class="kianfr--title">Taxonomy Option Framework</div>
    <p class="kianfr--text">Allows you to bring custom taxonomy settings to all of your categories, tags or CPT. We provide advanced settings with numerious number of fields.</p>
  </div>

  <div class="kianfr--col kianfr--col-first kianfr--last">
    <span class="kianfr--icon kianfr--<?php echo esc_attr( KIANFR::$premium ? 'active' : 'deactive' ); ?>"><i class="fas fa-<?php echo esc_attr( KIANFR::$premium ? 'check' : 'times' ); ?>"></i></span>
    <div class="kianfr--title">Profile Option Framework</div>
    <p class="kianfr--text">Allows you to bring custom user profile settings to all of users. We provide advanced settings with numerious number of fields.</p>
  </div>
  ...
  <div class="kianfr--col">
    ...
    <p class="kianfr--text">Allows you to creating custom widgets. We provide advanced settings wtih numerious number of fields.</p>
  </div>

  <div class="kianfr--col">
    <span class="kianfr--icon kianfr--<?php echo esc_attr( KIANFR::$premium ? 'active' : 'deactive' ); ?>"><i class="fas fa-<?php echo esc_attr( KIANFR::$premium ? 'check' : 'times' ); ?>"></i></span>
    <div class="kianfr--title">Comment Option Framework</div>
    <p class="kianfr--text">Allows you to bring custom comment metabox settings to all of comments. We provide advanced settings wtih numerious number of fields.</p>
  </div>

  <div class="kianfr--col kianfr--last">
    <span class="kianfr--icon kianfr--<?php echo esc_attr( KIANFR::$premium ? 'active' : 'deactive' ); ?>"><i class="fas fa-<?php echo esc_attr( KIANFR::$premium ? 'check' : 'times' ); ?>"></i></span>
    <div class="kianfr--title">Shortcode Option Framework</div>
    <p class="kianfr--text">Comes with pre-built shortcode editor to manage your content. It's easy and flexible to build unlimited layouts with endless possibilites.</p>
  </div>

  <?php if ( ! KIANFR::$premium ) { ?>
  <div class="clear"></div>
