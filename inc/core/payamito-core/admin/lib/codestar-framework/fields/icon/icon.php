...
if ( ! class_exists( 'KIANFR_Field_icon' ) ) {
  class KIANFR_Field_icon extends KIANFR_Fields {
    ...
    public function enqueue() {
      add_action( 'admin_footer', array( 'KIANFR_Field_icon', 'add_footer_modal_icon' ) );
      add_action( 'customize_controls_print_footer_scripts', array( 'KIANFR_Field_icon', 'add_footer_modal_icon' ) );
    }
          ...
          <div class="kianfr-modal-table-cell">
            ...
            <div class="kianfr-modal-inner">
              <div class="kianfr-modal-title">
                <?php esc_html_e( 'Add Icon', 'kianfr' ); ?>
                <div class="kianfr-modal-close kianfr-icon-close"></div>
              </div>
              <div class="kianfr-modal-header">
                <input type="text" placeholder="<?php esc_html_e( 'Search...', 'kianfr' ); ?>" class="kianfr-icon-search" />
              </div>
