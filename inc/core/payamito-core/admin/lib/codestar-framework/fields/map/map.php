  ...
  class KIANFR_Field_map extends KIANFR_Fields {
    ...
    public function enqueue() {
      ...
      if ( ! wp_script_is( 'kianfr-leaflet' ) ) {
        wp_enqueue_script( 'kianfr-leaflet', esc_url( $this->cdn_url . $this->version .'/dist/leaflet.js' ), array( 'kianfr' ), $this->version, true );
      }

      if ( ! wp_style_is( 'kianfr-leaflet' ) ) {
        wp_enqueue_style( 'kianfr-leaflet', esc_url( $this->cdn_url . $this->version .'/dist/leaflet.css' ), array(), $this->version );
      }
