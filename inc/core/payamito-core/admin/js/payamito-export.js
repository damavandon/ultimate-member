jQuery(document).ready(function ($) {
    ...
    $(".paymito-chosen-select").chosen({placeholder_text_multiple:" ",no_results_text:"",disable_search:true,allow_single_deselect: true,rtl:payamito_export.rtl,width:"100%"});
