...
if (!class_exists("Payamito_Cron")) {
    ...
    class Payamito_Cron
    {
        ...
        public static function remove_log($options)
        {
            ...
            $ids = Payamito_DB::select($table_name, $logic, null, ['id'], ['column' => 'date', 'order' => $order]);
        ...
        {
            $add = [
                ['key' => "payamito_two_weeks", 'interval'=> 1209600, 'display'=> __('Every two weeks',"payamito")],
                ['key' => "payamito_once_month", 'interval'=> 2592000, 'display'=>__('Every once month',"payamito")],
                ['key' => "payamito_three_months", 'interval' =>7776000, 'display' =>__('Every three months',"payamito")],
                ['key' => "payamito_six_months", 'interval'=> 15552000,'display'=>__('Every six months',"payamito")],
                ['key' => "payamito_once_year", 'interval'=> 31104000,'display'=>__('Every Once year',"payamito")]
            ];
