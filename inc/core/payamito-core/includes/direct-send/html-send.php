<div>
    <button class="button button-primary " type="button" value="send" id="btnPayamitoDirectSend"><?php esc_html_e('Fire', 'payamito') ?></button>
    <div id="payamitoDirectSendldBar" class="ldBar label-center" data-stroke="#ff9100" data-preset="fan" style="width:100%;height:100px"></div>

<div style="display:none"  id="divpayamitoDirectSendLoger">
<label class="custom-control-label" style="position: absolute;padding: 2% 0%; font-size: 15px;right: 7%;font-family: Vazir !important;font-weight: 400;" for="payamitoDirectSendLoger"><?php esc_html_e('Send Status', "payamito") ?></label>
<textarea id="payamitoDirectSendLoger" readonly style=" background:#fffefa ;width:100% ;border: 1px solid #ff9100; ;overflow-y: scroll;resize: none; overflow:auto;color:rgb(133 133 133) ; text-align:end" name="w3review" rows="4" cols="50"></textarea>
